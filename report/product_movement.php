            ...
            function displayWarehouseReport(data) {
                ...
                data.forEach(function (warehouse) {
                    ...
                    warehouse.products.forEach(function (product) {
                        ...
                        var $openingRow = $('<tr>').addClass('opening-balance');
                        $('<td>').text(product.movements[0].date).appendTo($openingRow);
                        $('<td>').text('-').appendTo($openingRow);
                        $('<td>').text('-').appendTo($openingRow);
                        $('<td>').text('-').appendTo($openingRow);
                        $('<td>').text('ยอดยกมา').appendTo($openingRow);
                        $('<td>').text(formatNumber(product.opening_balance) + ' ' + product.unit).appendTo($openingRow);
                        $openingRow.appendTo($tbody);
